  ...
  return (
    <div className='flex flex-col mt-5'>
        ...
        <div className='hidden lg:grid grid-cols-5 gap-5 px-5 mb-5 justify-between '>
            <img className='w-full hover:grayscale ' src={Images.instaPhoto1} alt="insta image 1" />
            <img className='w-full hover:grayscale ' src={Images.instaPhoto2} alt="insta image 2" />
            <img className='w-full hover:grayscale ' src={Images.instaPhoto3} alt="insta image 3" />
            <img className='w-full hover:grayscale ' src={Images.instaPhoto4} alt="insta image 2" />
            <img className='w-full hover:grayscale ' src={Images.instaPhoto5} alt="insta image 3" />
        </div>
