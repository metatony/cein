  ...
  return (
    <section className="px-4 container mx-auto">
      ...
      <div className="flex flex-col md:grid grid-cols-3 md:gap-4 space-y-5 md:space-y-0 justify-between items-center">
        <img className="w-full rounded-lg" src={Images.newArrivalsMobile} alt="new arrivals" />
        <img className="w-full rounded-lg" src={Images.casualEditMobile} alt="the casual edit" />
        <img className="w-full rounded-lg" src={Images.bestSellersMobile} alt="best sellers" />
      </div>
